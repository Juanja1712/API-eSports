...
export class TournamentsService {
  ...
  async registerMatchResult(tournamentId: number, matchId: number, winnerId: number, loserId: number, winnerScore: number, loserScore: number): Promise<Result> {
  ...
  async getMatchResults(tournamentId: number, minScore: number, page: number, limit: number, order: 'ASC' | 'DESC'): Promise<Result[]> {
